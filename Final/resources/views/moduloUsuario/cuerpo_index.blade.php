<div class="tab-pane fade show active" id="contenidoUsuarios" role="tabpanel" aria-labelledby="tabUsuarios">
  <div>
    <div class="form-row align-items-center mt-2">
      ...
      <div class="col-md-auto">
        <input type="text" class="form-control mb-2" id="username" placeholder="Nombre de usuario...">
      </div>
