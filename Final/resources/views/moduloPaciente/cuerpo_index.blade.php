<div class="tab-pane fade show active" id="contenidoPacientes" role="tabpanel" aria-labelledby="tabPacientes">
  <div>
      ...
      <div class="contentsclass">
        ...
        <div class="col-md-auto mb-2">
          <select class="custom-select inputBuscadorPaciente" id="tipoBusqueda" >
            ...
            <option value="nombre_y_apellido">Nombre y apellido</option>
            <option value="dni">Documento</option>
            <option value="historia_clinica">Historia clinica</option>
          </select>
        </div>
      </div>
      <div id="nombre_y_apellido" class="noneclass">
        <div class="col-md-auto mb-2 ml-auto px-md-0">
          <label for="bus_nombre">Nombre:</label>
        </div>
        <div class="col-md-auto">
          <input type="text" class="form-control mb-2 inputBuscadorPaciente" id="bus_nombre" placeholder="Nombre...">
        </div>
        <div class="col-md-auto mb-2 ml-2 px-md-0">
          <label for="bus_apellido">Apellido: </label>
        </div>
        <div class="col-md-auto">
          <input type="text" class="form-control mb-2 inputBuscadorPaciente" id="bus_apellido" placeholder="Apellido...">
        </div>
      </div>
      ...
      <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th class="textcenter" scope="col">Tipo documento</th>
            <th class="textcenter" scope="col">Numero de documento</th>
