    ...
    public function insertar_paciente($paciente)
    {
        ...
        if ($conexion !== null) {
            ...
            :genero_id,:tiene_documento,:tipo_doc_id,:numero,:tel,:nro_historia_clinica,:nro_carpeta,:obra_social_id,0)";
                ...
                $obLugar_nac = $this->nullToWhiteSpace($paciente->getLugar_nac());
                ...
                $obDomicilio = $this->nullToWhiteSpace($paciente->getDomicilio());
                ...
                $obTel = $this->nullToWhiteSpace($paciente->getTel());
