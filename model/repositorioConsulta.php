...
class RepositorioConsulta
{
    ...
    public function obtener_todos()/*devuelve lo mismo que con limite y pagina mas genero y localidad */
    {$result = array();
        ...
        if ($conexion !== null) {
            try {
                ...
                throw new Exception("error consulta repositorioconsultas->obtener_todos " . $ex->getMessage());
            }
        }
        $conexion = null;
        return $result;
    ...
    { $result = array();
        ...
        if ($conexion !== null) {
            try {
                 /* lo hago así para evitar concatenar directamente lo recibido por parametro */
                $or = '';
                switch ($campo) {
                    case 'genero':
                        $or = " ORDER BY genero";
