...
class RepositorioRol{
  ...
  public function obtener_por_id_usuario($id){/*si usuario no tiene roles el arreglo va a estar vacio
    */
      $roles=array();
      $conexion=abrir_conexion();
      if($conexion!==null){
  ...
  public function obtener_todos_los_roles(){ /*array vacio si no hay roles en la BD */
      $roles=array();
      $conexion=abrir_conexion();
      if($conexion!==null){
          try{
