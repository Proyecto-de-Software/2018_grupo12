...
function modificarUsuario(){
  ...
  $.ajax({
    url : 'usuarios/' + id,
    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
    data : { nombre:nombre, apellido:apellido, contrasena:contrasena, email:email },
    type : 'PUT',
    dataType: 'json',
    success : function(respuesta) {
      switch(respuesta.estado) {
...
function agregarRol() {
  ...
  $.ajax({
    url : 'usuarios/'+ id +'/roles/'+ idRol +'/agregar',
    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
    data : { },
    type : 'PUT',
    dataType: 'json',
...
function quitarRol() {
  ...
  $.ajax({
    url : 'usuarios/'+ id +'/roles/'+ idRol +'/quitar',
    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
    data : { },
    type : 'PUT',
    dataType: 'json',
